 ...
 */
declare const _default$c: react.ForwardRefExoticComponent<Props$e & react.RefAttributes<HTMLDivElement>>;
 ...
 */
declare const _default$b: react.ForwardRefExoticComponent<Props$d & react.RefAttributes<HTMLDivElement>>;

interface Props$c extends InputHTMLAttributes<HTMLDivElement> {
 ...
 */
declare const _default$a: react.ForwardRefExoticComponent<Props$c & react.RefAttributes<HTMLDivElement>>;
 ...
 */
declare function Icon({ size, name, fill, stroke, }: Props$b): react_jsx_runtime.JSX.Element;
 ...
 */
declare function Indicator({ size }: Props$a): react_jsx_runtime.JSX.Element;
...
type TextFieldVariantType = (typeof TextFieldVariant)[keyof typeof TextFieldVariant];
